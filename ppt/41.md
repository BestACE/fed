...
- 事件是接受用户交互的一种方式
	...
	- 摇一摇手机
- 参考资料
	1. [事件种类](http://javascript.ruanyifeng.com/dom/event-type.html)
	2. [事件模型](http://javascript.ruanyifeng.com/dom/event.html)
	3. [w3school](http://www.w3school.com.cn/js/js_htmldom_events.asp)
...
<img src="/img/41/001.png" alt="">

[slide] {:.flexbox.vleft}
## 事件捕获
- netscape提出并支持的事件处理方式
- 事件从抽象元素开始，逐级具体，最后最具体元素(从大到小)
<img src="/img/41/002.png" alt="">
